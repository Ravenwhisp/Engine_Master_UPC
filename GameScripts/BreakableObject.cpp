...
void BreakableObject::breakObject()
{
    ...
    if (m_brokenObjectTransform != nullptr)
    {
		...
		GameObject* dustEffect = GameObjectAPI::instantiatePrefab(GameObjectAPI::GetPrefabAssetReference("Assets/Prefabs/Particles/Dust_1.prefab"), TransformAPI::getGlobalPosition(m_brokenObjectTransform), Vector3(0.0f, 0.0f, 0.0f));
    }
