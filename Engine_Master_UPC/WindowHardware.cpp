...
void WindowHardware::vram()
{
    ...
    ImGui::ProgressBar(usedMB / budgetMB, ImVec2(-1, 0), "VRAM Usage");
}
...
void WindowHardware::gpuFeatures()
{
    ...
    if (ImGui::BeginTable("GPUCaps", 2, ImGuiTableFlags_RowBg | ImGuiTableFlags_BordersInnerV))
    {
        ImGui::TableSetupColumn("Feature");
        ImGui::TableSetupColumn("Supported");
        ImGui::TableHeadersRow();

        auto BoolText = [](bool v)
        {
            return v ? "Yes" : "No";
        };
