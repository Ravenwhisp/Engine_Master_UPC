...
private:
    static void serialiseNodeInto(const GameObject* go, rapidjson::Value& out, rapidjson::Document::AllocatorType& alloc);
    static void serialiseTransform(const GameObject* go, rapidjson::Value& out, rapidjson::Document::AllocatorType& alloc);
    static void serialiseComponents(const GameObject* go, rapidjson::Value& out, rapidjson::Document::AllocatorType& alloc);
