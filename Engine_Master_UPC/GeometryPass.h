...
public:
    ...
    {
        RenderSurface::GBUFFER_DIFFUSE,
        RenderSurface::GBUFFER_SPECULAR,
        RenderSurface::GBUFFER_NORMAL,
...
private:
    ...
    void transitionRenderTargets(ID3D12GraphicsCommandList4* commandList, D3D12_RESOURCE_STATES before, D3D12_RESOURCE_STATES after) const;
